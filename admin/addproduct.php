...
if(isset($_POST['add'])){
	...
	$sanpham_image_tmp=$_FILES['sanpham_image']['tmp_name'];
...
$sql=mysqli_query($conn,"INSERT INTO tbl_sanpham(category_id,sanpham_name,sanpham_gia,sanpham_giakhuyenmai,sanpham_active,sanpham_hot,sanpham_soluong,sanpham_image,sanpham_mota,baohanh,phukien,tinhtrang,trangthai)
 VALUES('$category_id','$sanpham_name','$sanpham_gia','$sanpham_giakhuyenmai','$sanpham_active','$sanpham_hot','$sanpham_soluong','$sanpham_image','$sanpham_mota','$baohanh','$phukien','$tinhtrang','$trangthai')");
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										<input required id="img" type="file" name="sanpham_image" class="form-control hidden" onchange="changeImg(this)">
									...
									<div class="form-group" >
										<label>Mô tả</label>
										<textarea  name="sanpham_mota"></textarea>
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										Có: <input type="radio" name="sanpham_hot" value="1">
										Không: <input type="radio" checked name="sanpham_hot" value="0">
									</div>
									<div class="form-group" >
										<label>Sản phẩm active</label><br>
										Có: <input type="radio" name="sanpham_active" value="1">
										Không: <input type="radio" checked name="sanpham_active" value="0">
									</div>
